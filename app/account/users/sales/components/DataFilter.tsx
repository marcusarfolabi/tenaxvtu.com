      ...
      <div className="flex items-center gap-2">
        {quickRanges.map((r) => (
          <button
            ...
            className="px-4 py-2 rounded-full text-[10px] font-black uppercase tracking-widest bg-foreground/5 text-foreground hover:bg-brand-gold hover:text-brand-black transition-all border border-transparent hover:border-brand-gold"
          >
            {r.label}
          </button>
        ))}
      ...
      <div className="flex items-center gap-3 bg-foreground/5 px-4 py-2 rounded-full border border-foreground/10">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="bg-transparent text-[11px] font-bold outline-none text-foreground color-scheme-dark focus:text-brand-gold transition-colors"
          />
