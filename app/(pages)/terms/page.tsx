  ...
  return (
    <div className="min-h-screen bg-white font-instrument pb-20">
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {terms.map((term, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 border border-gray-100 rounded-[2.5rem] transition-all hover:border-brand-red/30 hover:shadow-lg"
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-10 h-10 bg-brand-black rounded-xl flex items-center justify-center text-white">
                  {term.icon}
                </div>
                <h3 className="text-lg font-black text-brand-burgundy">{term.title}</h3>
              </div>
        ...
        {/* Termination Clause */}
        <div className="mt-12 p-10 bg-brand-red rounded-[3rem] text-brand-burgundy">
