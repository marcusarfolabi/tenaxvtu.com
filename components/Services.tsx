...
const services = [
  {
    ...
    icon: Smartphone,
    color: "bg-blue-500/10 text-blue-500", // Soft background, colored icon
  },
  {
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {services.map((s, i) => (
            <div
              key={i}
              className="group relative cursor-pointer p-8 rounded-[2.5rem] border border-foreground/5 transition-all duration-500 hover:border-brand-gold hover:shadow-2xl hover:shadow-brand-gold/10 bg-foreground/[0.02] dark:bg-foreground/[0.04] hover:-translate-y-2"
            >
              {/* Icon Container: Themed background with specific service color */}
              <div
