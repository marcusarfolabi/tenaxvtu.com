        ...
        > 
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="relative z-10 bg-clip-text text-transparent bg-linear-to-t from-brand-red via-red-500 to-foreground bg-position[100%_200%] animate-pulse">
                without the stress.
              </span>
              ...
              <motion.span
                ...
                className="absolute bottom-1 left-0 h-0.75 w-full bg-white shadow-[0_0_20px_#ff0000,0_0_40px_#8b1a1a] rounded-full z-0"
              >
              ...
              <span className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-3/4 h-8 bg-brand-red/20 blur-2xl -z-20" />
            </span>
          </motion.h1>
          ...
          >
            <Link
              href="/login"
              className="w-full sm:w-auto px-8 py-2 bg-foreground text-background rounded-2xl font-black text-lg hover:shadow-2xl hover:shadow-brand-red/30 active:scale-95 transition-all flex items-center justify-center gap-3 group"
            >
              Start Paying Now
