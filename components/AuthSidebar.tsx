...
export default function AuthSidebar({ 
  ...
  if (!mounted) {
    return <div className="hidden lg:flex lg:w-1/2 bg-background min-h-screen" />;
  }
  ...
  return (
    <>
      ...
      {/* 2. DESKTOP VIEW */}
      <div className="hidden lg:flex lg:w-1/2 bg-foreground/[0.03] p-16 flex-col justify-between relative overflow-hidden min-h-screen transition-colors duration-500 border-r border-foreground/5">
        
        {/* Pattern logic: Using foreground tint instead of a hardcoded pattern color */}
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-5">
            {[
              ...
              <div key={text} className="flex items-center gap-4 text-foreground/70 text-lg font-bold tracking-tight">
